...
def add_pipeline_args(subparser: argparse.ArgumentParser):
    ...
    subparser.add_argument(
        ...
        on RAM, default to this flag). If your file is too large to fit on RAM, please choose large_file option, \
        this will run approximate file shuffling that can handle files of any size on all supported platforms \
        (Linux, Mac OS, and Windows). If the input file should not be shuffled, do not include this flag, \
